...
inline CharacterDef blueKnightDef() {
	...
	m.parts.push_back({{-0.37f,0.77f,0},{0.08f,0.05f,0.08f},{0.85f,0.70f,0.55f,1},
		{-0.37f,1.40f,0},{1,0,0},50,PI,1});
	// Right: pauldron + arm + gauntlet + hand (amp=50)
	m.parts.push_back({{ 0.37f,1.38f,0},{0.14f,0.06f,0.14f},{0.55f,0.58f,0.62f,1},
		{ 0.37f,1.40f,0},{1,0,0},50,0,1});
	m.parts.push_back({{ 0.37f,1.08f,0},{0.10f,0.28f,0.10f},{0.12f,0.22f,0.55f,1},
		{ 0.37f,1.40f,0},{1,0,0},50,0,1});
	m.parts.push_back({{ 0.37f,0.86f,0},{0.12f,0.09f,0.12f},{0.38f,0.40f,0.45f,1},
		{ 0.37f,1.40f,0},{1,0,0},50,0,1});
	...
	c.slotRightHand = {{0.37f, 0.70f, -0.12f}, {0.04f, 0.30f, 0.04f},
		{0.37f,1.40f,0},{1,0,0},50,0,1};  // swings with right arm
...
inline CharacterDef crewmateDef() {
	...
	m.parts.push_back({{-0.46f,0.82f,0},{0.10f,0.15f,0.10f},{0.68f,0.14f,0.14f,1},
		{-0.36f,1.02f,0},{1,0,0},45,PI,1});
	m.parts.push_back({{ 0.46f,0.82f,0},{0.10f,0.15f,0.10f},{0.68f,0.14f,0.14f,1},
		{ 0.36f,1.02f,0},{1,0,0},45,0,1});
	// Legs + soles
	m.parts.push_back({{-0.15f,0.15f,0},{0.14f,0.15f,0.18f},{0.68f,0.14f,0.14f,1},
		{-0.15f,0.32f,0},{1,0,0},40,0,1});
	m.parts.push_back({{ 0.15f,0.15f,0},{0.14f,0.15f,0.18f},{0.68f,0.14f,0.14f,1},
		{ 0.15f,0.32f,0},{1,0,0},40,PI,1});
...
inline CharacterDef purpleMageDef() {
	...
	m.parts.push_back({{-0.10f,0.22f,0},{0.09f,0.22f,0.10f},{0.32f,0.06f,0.48f,1},
		{-0.10f,0.48f,0},{1,0,0},45,0,1});
	m.parts.push_back({{ 0.10f,0.22f,0},{0.09f,0.22f,0.10f},{0.32f,0.06f,0.48f,1},
		{ 0.10f,0.48f,0},{1,0,0},45,PI,1});
...
inline void registerAllCharacters(CharacterManager& mgr) {
	...
	// Jetpack: twin fuel tanks + frame + nozzles + flame effects
	{
		...
		jet.slotName = "back";
		jet.pieces = {
			{{0.38f,0.38f,0.42f,1},{-0.10f,0,0.03f},{0.08f,0.24f,0.08f}},       // tank L (bigger)
			{{0.38f,0.38f,0.42f,1},{ 0.10f,0,0.03f},{0.08f,0.24f,0.08f}},       // tank R
			{{0.50f,0.52f,0.55f,1},{-0.10f,0.24f,0.03f},{0.07f,0.04f,0.07f}},   // cap L
			{{0.50f,0.52f,0.55f,1},{ 0.10f,0.24f,0.03f},{0.07f,0.04f,0.07f}},   // cap R
			{{0.30f,0.30f,0.32f,1},{0,0.10f,0},{0.18f,0.03f,0.05f}},             // crossbar
			{{0.30f,0.30f,0.32f,1},{0,-0.02f,-0.02f},{0.03f,0.20f,0.03f}},       // spine
			{{0.25f,0.22f,0.22f,1},{-0.10f,-0.26f,0.03f},{0.07f,0.06f,0.07f}},   // nozzle L
			{{0.25f,0.22f,0.22f,1},{ 0.10f,-0.26f,0.03f},{0.07f,0.06f,0.07f}},   // nozzle R
			{{0.60f,0.30f,0.08f,1},{-0.10f,-0.30f,0.03f},{0.04f,0.03f,0.04f}},   // glow L
			{{0.60f,0.30f,0.08f,1},{ 0.10f,-0.30f,0.03f},{0.04f,0.03f,0.04f}},   // glow R
			{{0.28f,0.25f,0.22f,1},{-0.08f,0.18f,-0.08f},{0.03f,0.12f,0.03f}},   // strap L
			{{0.28f,0.25f,0.22f,1},{ 0.08f,0.18f,-0.08f},{0.03f,0.12f,0.03f}},   // strap R
		};
		...
		leftFlame.offset = {-0.10f, -0.30f, 0.03f};
		leftFlame.rate = 5;
		leftFlame.velocity = {0, -6.0f, 0};
		leftFlame.velocitySpread = 0.7f;
		leftFlame.colors = {{1,0.95f,0.8f,1},{1,0.75f,0.15f,1},{1,0.35f,0.05f,0.9f}};
		leftFlame.lifeMin = 0.08f; leftFlame.lifeMax = 0.30f;
		leftFlame.sizeMin = 0.04f; leftFlame.sizeMax = 0.08f;
		ParticleEmitterDef rightFlame = leftFlame;
		rightFlame.offset = {0.10f, -0.30f, 0.03f};
		flames.emitters = {leftFlame, rightFlame};
		jet.effects = {flames};
		mgr.addItemVisual(std::move(jet));
	}

	// Wood Pickaxe: handle + head (scaled up for visibility)
	mgr.addItemVisual({ItemId::WoodPickaxe, "right_hand", {
		{{0.50f, 0.35f, 0.15f, 1}, {0, 0, 0}, {0.03f, 0.38f, 0.03f}},        // handle (longer)
		{{0.55f, 0.55f, 0.58f, 1}, {0, 0.30f, 0}, {0.16f, 0.05f, 0.03f}},     // head (wider)
	}});

	// Stone Pickaxe
	mgr.addItemVisual({ItemId::StonePickaxe, "right_hand", {
		{{0.50f, 0.35f, 0.15f, 1}, {0, 0, 0}, {0.03f, 0.38f, 0.03f}},
		{{0.50f, 0.50f, 0.52f, 1}, {0, 0.30f, 0}, {0.18f, 0.06f, 0.04f}},
	}});

	// Wood Axe: handle + blade (bigger)
	mgr.addItemVisual({ItemId::WoodAxe, "right_hand", {
		{{0.50f, 0.35f, 0.15f, 1}, {0, 0, 0}, {0.03f, 0.38f, 0.03f}},
		{{0.55f, 0.55f, 0.58f, 1}, {0.05f, 0.26f, 0}, {0.10f, 0.12f, 0.03f}},
	}});

	// Wood Shovel: handle + flat head (bigger)
	mgr.addItemVisual({ItemId::WoodShovel, "right_hand", {
		{{0.50f, 0.35f, 0.15f, 1}, {0, 0, 0}, {0.03f, 0.40f, 0.03f}},
		{{0.55f, 0.45f, 0.30f, 1}, {0, 0.34f, 0}, {0.08f, 0.10f, 0.03f}},
	}});
