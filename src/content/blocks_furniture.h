...
inline void registerFurnitureBlocks(BlockRegistry& reg) {
	...
	reg.registerBlock({BT::Bed, "Bed", "crafted",
	...
	reg.registerBlock({BT::Stair, "Stair", "crafted",
	...
	reg.registerBlock({BT::Door, "Door", "crafted",
	...
	reg.registerBlock({BT::DoorOpen, "Door (Open)", "crafted",
		{0.60f,0.44f,0.24f},{0.55f,0.40f,0.20f},{0.55f,0.40f,0.20f},
