...
def action_convert(req: ConvertRequest):
    ...
    **Break block** → `from_item="wood"`, `convert_from_block=true`, `block_x/y/z`,
    `to_item="log"`, `convert_direct=false` (drop item entity).

    **Place block** → `from_item="stone"`, `convert_to_block=true`, `block_x/y/z`,
    `to_item="stone"`.

    **Use potion** → `from_item="potion"`, `from_count=1`, `to_item="hp"`, `to_count=4`.

    **Attack** → `convert_from_entity=<target_id>`, `from_item="hp"`, `from_count=<damage>`,
    `to_item=""` (destroy HP).

    **Lay egg** → `from_item="hp"`, `from_count=2`, `to_item="egg"`, `to_count=1`,
