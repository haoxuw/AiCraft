...
Launch:
    ...
    ./build/modcraft-server --template 4     # dedicated
"""

world = {
    "id":          "base:test_villager",
    "name":        "Test Villager",
    ...
    "mobs": [
        ...
        # woodcutter behavior discovers chests via scan_entities("base:chest").
        ...
        {"type": "base:dog",      "count": 1, "radius": 10},
    ],
}
