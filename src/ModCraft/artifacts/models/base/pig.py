...
model = {
    ...
    "parts": [
        ...
        {"role": "body", "offset": [-0.18, 0.18, -0.25], "size": [0.14, 0.24, 0.14], "color": [0.85, 0.45, 0.52, 1],
        ...
        {"role": "body", "offset": [0,    0.55, 0.43], "size": [0.07, 0.07, 0.08], "color": [0.85, 0.45, 0.52, 1],
         "pivot": [0, 0.50, 0.40], "swing_axis": [0,1,0], "amplitude": 15, "speed": 2},
        {"role": "body", "offset": [0.05, 0.62, 0.47], "size": [0.06, 0.06, 0.06], "color": [0.85, 0.45, 0.52, 1],
         "pivot": [0, 0.50, 0.40], "swing_axis": [0,1,0], "amplitude": 18, "speed": 2},
        {"role": "tail_tip", "offset": [0,    0.68, 0.44], "size": [0.05, 0.05, 0.05], "color": [0.62, 0.25, 0.30, 1],
